...
#client = LineClient()
client = LineClient(id='arsyan.alfaridz188@gmail.com', passwd='Arsyan22')
#client = LineClient(authToken='EpDwSWnDg1c6KE5n85d1.N9c42gyp6HMwf+hRIPEe0q.sfqq4pbJX6vchQcqwL7RehnDpL8DCFbCr01Eid19o/8=')
                    ...
                    if msg.contentType == 0:
                        if msg.toType == 2:
                            ...
                            if text.lower() == 'me':
                                ...
                                try:
                                    txt = ['iya','tidak','bisa jadi','ini bot gans']
